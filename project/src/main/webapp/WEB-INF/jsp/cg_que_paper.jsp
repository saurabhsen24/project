...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      ...
      <div class = "col-sm-9">
        <h1 class = "text-center">Prepare Questions for CG</h1>
        <hr/>
        <form action = "cg_que_paper" method = "post">
          ...
          <a href = "showQueCg" class = "btn btn-primary floatRight">Show Questions</a>
