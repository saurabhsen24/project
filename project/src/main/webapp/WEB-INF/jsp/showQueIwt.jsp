...
<div class = "container-fluid">
  ...
  <table class="table table-bordered">
    ...
    <tbody>
     <c:forEach var="question" items="${queListIwt}">   
      <tr>
        <td>${question.qid}</td>
        <td>${question.que}</td>
        <td>${question.opt1}</td>
        ...
        <td>${question.opt4}</td>
        <td>${question.ans}</td>     
        <td><a href = "updatequeIwt/${question.qid}" class = "btn btn-primary">Update</a></td>
        <td><a href = "deletequeIwt/${question.qid}" class = "btn btn-danger">Delete</a></td>
      </tr>
      </c:forEach>
    </tbody>
  </table>
  </div>
  <a href = "iwt_que_paper" class = "btn btn-info">Back</a>
    <a href = "loginTeacher" class = "btn btn-danger floatRight" onclick = "clearStorage()">Logout</a>
     </div>
   </div>
</div>
</section>
