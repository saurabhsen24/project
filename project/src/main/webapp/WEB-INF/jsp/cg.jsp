...
<html lang="en">
<head>
  <title>COMPUTER GRAPHICS QUESTION PAPER</title>
  <meta charset="utf-8">
...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      ...
      <div class = "col-sm-9">
        <div class = "mydash">
          <h3 class = "text-font">COMPUTER GRAPHICS</h3>
           <%! int i = 1; %>
          <div class = "text-center time_clock">Time Remaining :<span><p id = "counter"></p></span></div>
    
          <form  method = "get" action = "resultCg">
          <c:forEach var = "q" items = "${cgQues}">
       ...
       if(seconds == 0 && mins > -1){
           ...
           if(mins < 0){
             clearInterval(timeIntervalId);            
        	   ...
        	   location.href = "/project/resultCg";
           }
       }
   },1000);
 }
