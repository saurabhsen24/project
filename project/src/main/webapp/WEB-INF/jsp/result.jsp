...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      ...
      <div class = "col-sm-9">
        <div class = "mydash">
          <h3 class = "text-font">IWT</h3>
          <c:set var = "iwtAns" value = "${iwtQues}"/>
          ...
          <p class = "para-text text-center">
            <%
               ...
               //out.println(mapQueToAns);
                  int marks = 0;
               //List<Question> quesList = (List)pageContext.getAttribute("iwtAns");
               //for(Question que : quesList){
            	  //out.println(que.getQid()+"   "+que.getAns()+"--->"+mapQueToAns.get(que.getQid()+"")+"<br/>");
            	 //  if(que.getAns().equals(mapQueToAns.get(que.getQid()+"").trim())){
            		//   ++marks;
            	 //  }
               //}               
               //out.println(quesList);
