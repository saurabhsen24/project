...
<html lang="en">
<head>
  <title>CLOUD QUESTION PAPER</title>
  <meta charset="utf-8">
...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      ...
      <div class = "col-sm-9">
        <div class = "mydash">
          <h3 class = "text-font">CLOUD COMPUTING</h3>
          <div class = "text-center time_clock">Time Remaining :<span><p id = "counter"></p></span></div>
           <%! int i = 1; %>
          <form  method = "get" action = "resultCc">
          <c:forEach var = "q" items = "${ccQues}">
       ...
       if(seconds == 0 && mins > -1){
           ...
           if(mins < 0){
             clearInterval(timeIntervalId);           
        	   ...
        	   location.href = "/project/resultCc";
           }
       }
   },100);
 }
