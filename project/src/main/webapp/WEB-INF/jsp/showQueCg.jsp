...
<div class = "container-fluid">
  ...
  <table class="table table-bordered">
    ...
    <tbody>
     <c:forEach var="question" items="${queListCg}">   
      <tr>
        <td>${question.qid}</td>
        <td>${question.que}</td>
        <td>${question.opt1}</td>
        ...
        <td>${question.opt4}</td>
        <td>${question.ans}</td>     
        <td><a href = "updatequeCg/${question.qid}" class = "btn btn-primary">Update</a></td>
        <td><a href = "deletequeCg/${question.qid}" class = "btn btn-danger">Delete</a></td>
      </tr>
      </c:forEach>
    </tbody>
  </table>
  </div>
  <a href = "cg_que_paper" class = "btn btn-info">Back</a>
