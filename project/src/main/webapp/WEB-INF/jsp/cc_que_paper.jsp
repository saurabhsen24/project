...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      ...
      <div class = "col-sm-9">
        <h1 class = "text-center">Prepare Questions for Cloud</h1>
        <hr/>
        <form action = "cc_que_paper" method = "post">
          ...
          <a href = "showQueCc" class = "btn btn-primary floatRight">Show Questions</a>
