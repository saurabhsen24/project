...
<html lang="en">
<head>
  <title>SOFTWARE ARCHITECTURE QUESTION PAPER</title>
  <meta charset="utf-8">
...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      ...
      <div class = "col-sm-9">
        <div class = "mydash">
          <h3 class = "text-font">SOFTWARE ARCHITECTURE</h3>
           <%! int i = 1; %>
          <div class = "text-center time_clock">Time Remaining :<span><p id = "counter"></p></span></div>
    
          <form  method = "get" action = "resultSa">
          <c:forEach var = "q" items = "${saQues}">
       ...
       if(seconds == 0 && mins > -1){
           ...
           if(mins < 0){
             clearInterval(timeIntervalId);            
        	   ...
        	   location.href = "/project/resultSa";
           }
       }
   },1000);
 }
