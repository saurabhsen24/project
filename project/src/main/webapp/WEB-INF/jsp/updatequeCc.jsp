...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      ...
      <div class = "col-sm-9">
        <h1 class = "text-center">Update Questions for IWT </h1>
        <hr/>      
                 
        <form action = "showQueCc/${question.qid}" method = "post">

          <div class="form-group">
            <label for = "qid">Que ID:</label>
            <input type="text" class="form-control" id="qid" placeholder="Enter Question ID" name = "qid" value = "${question.qid}"  required="required"></input>
          </div>
                      
          <div class="form-group">
            <label for = "que">Enter Question:</label>
            <textarea class="form-control" rows="5" id="que" name = "que" required="required">${question.que}</textarea>
          </div>
          
          <div class="form-group">
            <label for = "opt1">Option 1</label>
            <input type="text" class="form-control" id="opt1" placeholder="Enter option" name = "opt1" value = "${question.opt1}" required="required"></input>
          </div>

          <div class="form-group">
            <label for = "opt2">Option 2</label>
            <input type="text" class="form-control" id="opt2" placeholder="Enter option" name = "opt2" value = "${question.opt2}" required="required"></input>
          </div>

          <div class="form-group">
            <label for = "opt3">Option 3</label>
            <input type="text" class="form-control" id="opt3" placeholder="Enter option" name = "opt3" value = "${question.opt3}" required="required"></input>
          </div>

          <div class="form-group">
            <label for = "opt4">Option 4</label>
            <input type="text" class="form-control" id="opt4" placeholder="Enter option" name = "opt4" value = "${question.opt4}" required="required"></input>
          </div>          
          
          <div class="form-group">
            <label for = "ans">Enter the Answer :</label>
            <input type="text" class="form-control" id="ans" placeholder="Enter Answer" name = "ans" value = "${question.ans}" required="required"></input>
          </div>
