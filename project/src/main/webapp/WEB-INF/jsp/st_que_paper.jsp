...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      ...
      <div class = "col-sm-9">
        <h1 class = "text-center">Prepare Questions for ST</h1>
        <hr/>
        <form action = "st_que_paper" method = "post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="opt1" placeholder="Enter option" name = "opt1">
          </div>

          <div class="form-group">
            <label for = "opt2">Option 2</label>
            <input type="text" class="form-control" id="opt2" placeholder="Enter option" name = "opt2">
          </div>

          <div class="form-group">
            <label for = "opt3">Option 3</label>
            <input type="text" class="form-control" id="opt3" placeholder="Enter option" name = "opt3">
          </div>

          <div class="form-group">
            <label for = "opt4">Option 4</label>
            <input type="text" class="form-control" id="opt4" placeholder="Enter option" name = "opt4">
          </div>          
          ...
          <a href = "showQueSt" class = "btn btn-primary floatRight">Show Questions</a>
