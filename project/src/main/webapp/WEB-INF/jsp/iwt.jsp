...
<html lang="en">
<head>
  <title>INTERNET WEB TECHNOLOGY QUESTION PAPER</title>
  <meta charset="utf-8">
...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      <div class="collapse navbar-collapse" id="myNavbar">
         <div class = "navbar-default rightpart">
              <ul class="nav nav-pills nav-stacked" role="tablist">
                ...
                <li><a href="dashboardStudent"><span><i class="fas fa-tachometer-alt"></i></span>
                  DASHBOARD</a></li>
      ...
      <div class = "col-sm-9">
        <div class = "mydash">
          <h3 class = "text-font">INTERNET WEB TECHNOLOGY</h3>     
           <%! int i = 1; %>
          <div class = "text-center time_clock">Time Remaining :<span><p id = "counter"></p></span></div>
          <form  method = "get" action = "resultIwt">
          <c:forEach var = "q" items = "${iwtQues}">
          ...
          <% i = 1; %>
          <!--a href = "result" class = "btn btn-success">SUBMIT</a>  -->
       ...
       if(seconds == 0 && mins > -1){
           ...
           if(mins < 0){
             clearInterval(timeIntervalId);
        	   ...
        	   location.href = "/project/resultIwt";
           }
       }
   },1000);
 }
