...
<div class = "container-fluid">
   <div class = "col-xs-12">
    <div class = "col-sm-3">
      ...
      <div class = "col-sm-9">
        <h1 class = "text-center">Prepare Questions for SA</h1>
        <hr/>
        <form action = "sa_que_paper" method = "post">
          ...
          <a href = "showQueSa" class = "btn btn-primary floatRight">Show Questions</a>
