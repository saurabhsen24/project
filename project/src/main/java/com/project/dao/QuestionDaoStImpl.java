...
@Repository
public class QuestionDaoStImpl implements QuestionDaoSt{

	@Autowired
	private JdbcTemplate jdbcTemplate;

	private static final String INSERT_QUERY = "INSERT INTO QUESTIONST(que,opt1,opt2,opt3,opt4,ans) values(?,?,?,?,?,?)";
	private static final String SELECT_ALL = "SELECT * from QUESTIONST";
	private static final String UPDATE_QUERY = "UPDATE QUESTIONST SET qid = ?,que = ?,opt1 = ?,opt2 = ?,opt3 = ?,opt4 = ?,ans = ? where qid = ?"; 
	private static final String DELETE_QUERY = "DELETE from QUESTIONST where qid = ?";	
