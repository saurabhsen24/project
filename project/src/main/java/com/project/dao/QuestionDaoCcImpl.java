...
@Repository
public class QuestionDaoCcImpl implements QuestionDaoCc{
	
	@Autowired
	private JdbcTemplate jdbcTemplate;

	private static final String INSERT_QUERY = "INSERT INTO QUESTIONCC(que,opt1,opt2,opt3,opt4,ans) values(?,?,?,?,?,?)";
	private static final String SELECT_ALL = "SELECT * from QUESTIONCC";
	private static final String UPDATE_QUERY = "UPDATE QUESTIONCC SET qid = ?,que = ?,opt1 = ?,opt2 = ?,opt3 = ?,opt4 = ?,ans = ? where qid = ?"; 
	private static final String DELETE_QUERY = "DELETE from QUESTIONCC where qid = ?";	
