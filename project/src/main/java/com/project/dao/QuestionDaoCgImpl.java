...
@Repository
public class QuestionDaoCgImpl implements QuestionDaoCg{

	@Autowired
	private JdbcTemplate jdbcTemplate;

	private static final String INSERT_QUERY = "INSERT INTO QUESTIONCG(que,opt1,opt2,opt3,opt4,ans) values(?,?,?,?,?,?)";
	private static final String SELECT_ALL = "SELECT * from QUESTIONCG";
	private static final String UPDATE_QUERY = "UPDATE QUESTIONCG SET qid = ?,que = ?,opt1 = ?,opt2 = ?,opt3 = ?,opt4 = ?,ans = ? where qid = ?"; 
	private static final String DELETE_QUERY = "DELETE from QUESTIONCG where qid = ?";	
