...
@Service
public class QuestionServiceIwtImpl implements QuestionServiceIwt{

	@Autowired
	private QuestionDaoIwt queDao;
	...
	public QuestionDaoIwt getQueDao() {
		return queDao;
	}

	public void setQueDao(QuestionDaoIwt queDao) {
		this.queDao = queDao;
	}
